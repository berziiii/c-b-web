...
if(isset($_POST)) {
	...
	// and entering smtp:yourdomain.com smtp:berzelba@gmail.com
  ...
  // $result = $mailer->send($message);
	...
	$message = Swift_Message::newInstance('An RSVP for the Wedding')
	  ->setFrom(array('brian@offpistedesigns.com' => 'Wedding RSVP'))
	  ->setTo(array('brian@offpistedesigns.com' => 'Brian Berzellini', 'candaceevebrown@gmail.com' => 'Candace Brown', 'berzelba@gmail.com' => 'Brian Berzellini'))
    ->setBody($messageText);
//                           ^                    ^
